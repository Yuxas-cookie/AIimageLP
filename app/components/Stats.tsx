      ...
      {stats.map((stat, index) => (
        ...
        >
          <div className="content-container text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl font-semibold mb-8 sm:mb-10 md:mb-12 bg-gradient-to-r from-red-600 via-orange-400 to-red-600 bg-clip-text text-transparent" style={{WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>
              {stat.text}
            </p>

            <div className="mt-8 sm:mt-10 space-y-6 sm:space-y-8 text-gray-700 leading-loose text-base sm:text-lg md:text-xl">
              <p>
